...
class isrMain:
    def __init__(self):
        ...
        toggleSide = Gtk.ToggleToolButton.new_from_stock("view-sidebar-symbolic")
        menu.insert (fileNew, 0)
        menu.insert (fileOpen, 1)
        menu.insert (toggleSide, 2)
        ...
        innerVbox.pack_start (recordingsView, True, True, 3)
        ...
        column = Gtk.HBox()
        outterBoxLayout.pack_start(column, False, False, 0)


        self.currentRecording = isrNewRecording.NewRecording ()
        self.currentRecording.startRecordButton.connect ("clicked",
                                                  self.new_record_setup_done)

        column.pack_start(self.currentRecording, False, False, 0)
        column.pack_start (innerVbox, True, True, 1)
